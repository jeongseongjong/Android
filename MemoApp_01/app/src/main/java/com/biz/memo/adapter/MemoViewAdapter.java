...
public class MemoViewAdapter extends RecyclerView.Adapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        /*
            memo_tiem.xml파일을 가져와서 view객체로 생성(확장)하기
         */
    ...
    /*
        memoList의 개수만큼 생성되어서 화면에 표시도리 때 반복문으로 호출되는 메소드
        반복문이 호출되면서 몇번째 데이터인지 position변수에 주입한다.
     */
    @Override
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        /*
            memoList의 각 아이템요소를 한개씩 읽어서
            TextView setText() method를 이용해서 문자열을 채워넣어준다.
         */
    ...
    //    memoHolder.item_btn_delete.setOnClickListener(new View.OnClickListener(){});
        ...
        // 이벤트를 MainActivity로 옮겨서 거기에서 설정을 한 후 가져와서
        // 처리를 해줘야 한다.
