...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        view_adapter = new MemoViewAdapter(MainActivity.this);
        ...
        /*
            DB의 데이터가 변경되어
            이전에 selectAll() 가져온 리스트에 변동이 발생하면
            observe() method가 알람을 주고 onChanged 이벤트가 발생을 한다.
        ...
        76번줄부터 지금줄까지 주석처리된 코드는 아래 86번줄의 코드와 같은 의미이다.
        */
    ...
    public void onClick(View v) {
        ...
        // memoViewModel의 insert 메소드를 호출하여 DB에 memoVO 데이터를 저장
