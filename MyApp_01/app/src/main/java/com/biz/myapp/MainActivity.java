...
/*
    ...
    Acibity자체를 이벤트 핸들러로 선언
    View.On** 클래스를 implement해주고
    on**() method를 구현해주는 방식
...
//        btn1.setOnClickListener( this );
        ...
        FloatingActionButton fab = findViewById(R.id.fab);
                            /*
                                View : 눈에 보이는 모든것의 부모 클래스
                                다른곳에서는 Component라고 칭한다.
                             */
        /*
            이벤트 핸들링 첫번째 방식
    ...
    /*
        ...
        대체로 이벤트 처리 코드가 비슷한경우
        한번만 이벤트 처리 코드를 작성하고 view들이 공유해서 사용하기 위함

        v.getId() method를 이용해서 누가 호출했는지 구분해서 코드를 진행하면 된다.
     */
    @Override
