...
/*
    ...
    모두 View 클래스를 상속ㅂ다아서 만들어진 component들이다
    어떤 이벤트나 액션등을 지정할 때
    기존에 클래스나 인터페이스를 상속 또는 implement해야 하는데
    그때 자기 자신의 클래스를 사용하지 않고 View클래스의 요소들을 상속받아
    클래스를 작성하는 것이 원칙이다.
 */
public class MyViewClass implements View.OnClickListener{
    ...
    public void onClick(View v) {
        ...
        if(v.getId() == R.id.btn1){
            ...
            /*
                이벤트가 발생한 veiw(comp)로 부터 어떤 값을 얻어 오고자 하면
